...
{synopt:{opt btp:(#)}} perform # bootstrap replications; default is btp(200);{p_end}
...
2. The command generates a new variable y which stores the negative value of the 
dependent variable. After estimation, users can drop this variable.

{marker examples}{...}
{title:Examples}

{phang}{cmd:. eqreg log_wage black hispanic age AFQT0 AFQT0_2} {space 13} (black is the homoskedatic variable to be estimated){p_end}
