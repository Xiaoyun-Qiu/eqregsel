*!Quantile Regression, Xiaoyun Qiu 30july2015

//------------------------------------------------------------------------------
//compute tempx1 for the mata function
capture program drop debug_myfun_hetero
program debug_myfun_hetero,eclass 
	version 13
...
{	
	...
	st_matrix("e(tempx)",tempx)
	st_matrix("e(mtempy)",mtempy)
	st_matrix("e(mtempx1)",mtempx1)
	st_matrix("e(dtemp)",dtemp)
	st_matrix("e(Tri)",Tri)
