...
{phang}
{bf:eqregsel} {hline 5} Estimation Method Using Extremal Quantile Regression under Endogenous Selection
...
{synoptline}
{syntab:Options}
{synopt:{opt hom(#)}}Estimate the coefficients of the first # independent variables; 
		default is hom(1){p_end}
{synopt:{opt subs(#)}}Subsampling size used for selecting optimal quantile index tau; 
		default is based on the size of the dataset{p_end}
{synopt:{opt grid(#)}}Discretize the interval of tau into # subintervals;  
		default is grid(40){p_end}
{synopt:{opt rep(#)}}Perform # bootstrap replications; default is rep(150);{p_end}
{synoptline}
{p2colreset}{...}
...
{pstd}
{cmd:eqregsel} estimates and provides inference for the coefficient of variables of interest under 
...
{phang}{cmd:eqregsel} saves the following results in {cmd:e()}:
...
{col 10}{cmd:e(subs)}{col 32}Subsampling size in the bootsratpping process
...
{phang}{cmd:. eqregsel log_wage black hispanic age AFQT0 AFQT0_2} {space 13} (black is the variable of interest){p_end}

{phang}{cmd:. eqregsel log_wage black hispanic age AFQT0 AFQT0_2, hom(2)} {space 5} (black and hispanic are variables of interest){p_end}

{phang}{cmd:. eqregsel log_wage black hispanic age AFQT0 AFQT0_2, rep(300)}{p_end}
