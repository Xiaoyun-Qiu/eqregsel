...
program eqreg,eclass 
	...
	* SELECT OPTIMAL TAU
	forvalues gg = 1/`G'{
		...
		qui qreg_simplified `varlist',quantile(`tau') cformat(%10.0g)
		mat theta = e(b)'
		...
		* CALL MYFUN_HOM_NEW()
		...
		forvalues j = 1/`J'{
			...
			qui qreg_simplified `varlist',quantile(`tau1') cformat(%10.0g)
			mat pf[1,`j'+1] = e(b)'		
		} 
	...
	* BOOTSTRAP THE CONFIDENCE INTERVAL
	...
	forvalues bb = 1/`B'{
			...
			* CALL MYFUN_HOM_NEW()
			...
			mat pf = J(`d',`J'+1,0)
			qui qreg_simplified `varlist',quantile(`tau0') cformat(%10.0g)
			mat pf[1,1] = e(b)'
			forvalues j = 1/`J'{
